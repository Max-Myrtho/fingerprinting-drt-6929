...
const CustomFingerprint = () => {
  ...
  return (
    ...
    >
      <h4>
        Votre résolution actuelle: <u>{resolution}</u>
      </h4>
      <b>Sur ce site, vous êtes identifié par ce fingerprint:</b>
      <br />
      {fingerprint ? (
        <span className="bg-black text-white rounded-md px-2 p-0.5">
          {fingerprint}
        </span>
      ) : (
      ...
      <hr className="mt-4" />
      <p className="italic">
        Ce fingerprint a été calculé en fonction de votre résolution actuelle et
        de votre fuseau horaire uniquement.
      </p>
    </div>
  );
};
